...
/****** Equal (min-height) for textes,titles, exc in inline blocs *****/
        ...
        max_heightTxt('.glob-container .image-content');
        max_heightTxt('.glob-container .image-container');
...
jQuery(document).ready(function(jQuery) {
    ...
    jQuery(".acf-field-64d38e5b22c75, .acf-field-6596867586d15,.acf-field-64b0223d946c9, .acf-field-64b020b56a893").wrapAll("<div class='block-liens-datas' />");
    ...
    jQuery(headerDivNiveau).insertBefore(".acf-field-64b02109946c5");  // Insérer 
