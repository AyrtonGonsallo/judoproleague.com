				...
				<div class="judo_pro_league desktop">
					<div class="nv-bloc-rencontre">
						<div class="nv-rencontre-equipe">
							...
							<a class="nv-renc-equip-link" href="<?php echo get_the_permalink($equipe1->ID  );?>">
							...
							<div class="nv-equip-1">
							<a class="nv-renc-equip-link" href="<?php echo get_the_permalink($equipe2->ID  );?>">
							...
							if( have_rows('combats',$post_id) ){
								...
								while ( have_rows('combats',$post_id) ) : the_row();
									...
									<div class="result-jdk">
										...
										<h3 class="<?php if ($judoka_gagnant!=null && $judoka_gagnant==1){echo 'gagnant';}?>"><?php echo get_the_title($judoka_equipe_1[0]->ID ); ?>	</h3>
										</a>
										...
										<div class="rgt-result-jdk">
											...
											<h3 class="<?php if ($judoka_gagnant!=null && $judoka_gagnant==2){echo 'gagnant';}?>"><?php echo get_the_title($judoka_equipe_2[0]->ID ); ?></h3>
											</a>
										</div>
									</div>
								<?php endwhile;
