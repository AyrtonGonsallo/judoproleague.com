...
$args_j1= array(		'post_type'=> 'rencontre',		'posts_per_page' => -1,'meta_query'     => array(  'relation' => 'and',   array(      'key'        => 'niveau',      'compare'    => '=',      'value'      => 'Phase de poules'    ),
		array(      
    ...
    <section class="pd-5">
        ...
        <div class="judo_pro_league">
            <div class="journees">
                ...
                <h3 class="nv-journee-cl">
                    <a href="<?php echo $team_permalink;?>phase-eliminatoire/poule-B?saison_value=<?php echo $saison_value;?>">
                        Poule B
                    </a>
                </h3>
                <h3 class="nv-journee-cl">
            ...
            ?>
                ...
                <div class="table-23">
                    ...
                    <div class="table-team table-no-lb table-no-rb">
                        <h3 class="table-tname"> <?= $clt[0]['nom']?$clt[0]['nom']:$clt[0]['error'];?></h3>
                    </div>
                    <div class="table-results">
