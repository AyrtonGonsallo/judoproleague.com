    ...
    <section>
        ...
        <div id="tabs" class="tabs-poules">
            ...
            <div id="tabs-1">
                ...
                <?php display_rencontre_journee_poule($rencontres_j1_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j1_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j1_pouleD,'D');?>
            </div>
            <div id="tabs-2">
                <?php display_rencontre_journee_poule($rencontres_j2_pouleA,'A');?>
                <?php display_rencontre_journee_poule($rencontres_j2_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j2_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j2_pouleD,'D');?>
            </div>
            <div id="tabs-3">
                <?php display_rencontre_journee_poule($rencontres_j3_pouleA,'A');?>
                <?php display_rencontre_journee_poule($rencontres_j3_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j3_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j3_pouleD,'D');?>
            </div>
            <div id="tabs-4">
                <?php display_rencontre_journee_poule($rencontres_j4_pouleA,'A');?>
                <?php display_rencontre_journee_poule($rencontres_j4_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j4_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j4_pouleD,'D');?>
            </div>
            <div id="tabs-5">
                <?php display_rencontre_journee_poule($rencontres_j5_pouleA,'A');?>
                <?php display_rencontre_journee_poule($rencontres_j5_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j5_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j5_pouleD,'D');?>
            </div>
            <div id="tabs-6">
                <?php display_rencontre_journee_poule($rencontres_j6_pouleA,'A');?>
                <?php display_rencontre_journee_poule($rencontres_j6_pouleB,'B');?>
                <?php display_rencontre_journee_poule($rencontres_j6_pouleC,'C');?>
                <?php display_rencontre_journee_poule($rencontres_j6_pouleD,'D');?>
            </div>
        </div>
