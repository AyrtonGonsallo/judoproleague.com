...
<?php  function get_classement($rencontres,$saison_value){
	...
	foreach($results as $result){
		array_push($sorted_result_ids,array("id"=>$result[0]["nom"],"matchs_v"=>$result[0]["matchs_v"],"points_totaux"=>$result[0]["points"],"points"=>$result[0]["points"],"points_marqués"=>$result[0]["points_marqués"],"ippons_marqués"=>$result[0]["ippons_marqués"]));
	}
