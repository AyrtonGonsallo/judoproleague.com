		...
		if($matchs_liste){
			...
			foreach($matchs_liste as $matchs){
				...
				foreach($matchs['combats'] as $match){
					...
					$results[$phase->post_title][$equipe1->post_title]=[array("nom"=>$equipe1->post_title)];
					$results[$phase->post_title][$equipe2->post_title]=[array("nom"=>$equipe2->post_title)];
		...
		if($matchs_liste){
			...
			foreach($matchs_liste as $matchs){
				...
				foreach($matchs['combats'] as $match){
					...
					$equipe2=get_field( 'equipe_judoka',$judoka2->ID )[0];
					if($i==0){
						$results[$phase->post_title][$equipe1->post_title][0]["nombre_de_rencontres"]+=1;
						$results[$phase->post_title][$equipe2->post_title][0]["nombre_de_rencontres"]+=1;
					}
					...
					if ($match['valeur_ippon_judoka_1']==1){
						$ippons_equ1+=1;
						$results[$phase->post_title][$equipe1->post_title][0]["ippons_marqués"]+=1;
						$results[$phase->post_title][$equipe2->post_title][0]["ippons_concédés"]+=1;
					}
					if ($match['valeur_ippon_judoka_2']==1){
						$ippons_equ2+=1;
						$results[$phase->post_title][$equipe2->post_title][0]["ippons_marqués"]+=1;
						$results[$phase->post_title][$equipe1->post_title][0]["ippons_concédés"]+=1;
					}
					if ($match['valeur_wazari__judoka_1']==1){
						$results[$phase->post_title][$equipe1->post_title][0]["wazaris_marqués"]+=1;
						$results[$phase->post_title][$equipe2->post_title][0]["wazaris_concédés"]+=1;
					}
					if ($match['valeur_wazari__judoka_2']==1){
						$results[$phase->post_title][$equipe2->post_title][0]["wazaris_marqués"]+=1;
						$results[$phase->post_title][$equipe1->post_title][0]["wazaris_concédés"]+=1;
					}
					$i++;
					$results[$phase->post_title][$equipe1->post_title][0]["step"]=$phase->post_title;
					$results[$phase->post_title][$equipe2->post_title][0]["step"]=$phase->post_title;
				...
				if ($winner=='équipe 1'){
					$results[$phase->post_title][$equipe1->post_title][0]["victoires"]+=1;
					$results[$phase->post_title][$equipe2->post_title][0]["defaites"]+=1;
					$results[$phase->post_title][$equipe1->post_title][0]["points"]+=3;
					$results[$phase->post_title][$equipe2->post_title][0]["points"]+=0;
				}
				if ($winner=='inconnue'){
					$results[$phase->post_title][$equipe1->post_title][0]["nuls"]+=1;
					$results[$phase->post_title][$equipe2->post_title][0]["nuls"]+=1;
					$results[$phase->post_title][$equipe1->post_title][0]["points"]+=1;
					$results[$phase->post_title][$equipe2->post_title][0]["points"]+=1;
				}
				if ($winner=='équipe 2'){
					$results[$phase->post_title][$equipe1->post_title][0]["defaites"]+=1;
					$results[$phase->post_title][$equipe2->post_title][0]["victoires"]+=1;
					$results[$phase->post_title][$equipe1->post_title][0]["points"]+=0;
					$results[$phase->post_title][$equipe2->post_title][0]["points"]+=3;
				}
