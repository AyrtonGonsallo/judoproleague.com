    ...
    <div class="classement-23 judo_pro_league classement-24">
        ...
        <div class="header-table bb2 bleu-score background-score">Combats</div>
            ...
            foreach($classement as $clt):
                if(($pos>1) && (($clt[0]['points'])<$points_prec) ){
                    $rang++;
                }else if(($pos>1) && (($clt[0]['points'])==$points_prec)){
                ...
                //echo "actuel: ".($clt[0]['points'])."prec: ".$points_prec;
            ?>
                ...
                <div class="table-23">
                    ...
                    <div class="table-results">
                        <div class="td-table gras table-no-lb table-no-rb"><?= ($clt[0]['points']);?></div>
